package com.marouane.servicesecurityauth2jwt.web;
...
private UserDetailsService userDetailsService;
    ...
    @GetMapping("/dataTests")
    @PreAuthorize("hasAuthority('SCOPE_USER')")
 Map<String, Object> datasets(Authentication authentication){
...
@PostMapping("/token")
    ...
    JwtClaimsSet jwtClaimsSet=JwtClaimsSet.builder()
            ...
            .issuer("serviceSecurity-Auth2JWT")
            .claim("scope",scope)
            .build();
...
idToken.put("refresfToken",jwtRefreshToken);
}
